        ...
        <form class="form-horizontal my-4" method="POST" action="sign-in-do">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" value="" id="phone" name="phone" placeholder="Утас">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="password" class="form-control" id="userpassword" value="" name="userpassword" placeholder="Нууц үг оруулах">
                </div>
            </div>
